        ...
        switch (this.id) {
            case "login-form":
                ...
                $.ajax({
                    method: "post",
                    url: "/Login/SignIn",
                    data: { login_username: $lg_username, login_password: $lg_password }
                }).done(function (res) {
                    if (res.hasError) {
            ...
            case "register-form":
                ...
                var $rg_surname = $('#register_surname').val();
                ...
                $.ajax({
                    method: "post",
                    url: "/Login/SignUp",
                    data: { register_name: $rg_name, register_surname: $rg_surname, register_username: $rg_username, register_email: $rg_email, register_password: $rg_password }
                }).done(function (res) {
                    if (res.hasError) {
